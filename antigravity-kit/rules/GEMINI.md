...
| **WEB** (Next.js, React web)           | `frontend-specialist` | nextjs-react-expert, frontend-design |
| **BACKEND** (API, server, DB)          | `backend-specialist`  | api-patterns, nodejs-best-practices |
...
| `i18n_checker.py`          | i18n-localization     | Post-localization   |
...
- **Audits**: `ux_audit.py`, `geo_checker.py`, `lighthouse_audit.py`, `seo_checker.py`
